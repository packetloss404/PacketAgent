...
export const TEMPLATE_DEFINITIONS: TemplateDefinition[] = [
  {
    ...
    pages: [
      ...
      page("/crm", "Pipeline", "private", "Review active sales pipeline health.", "deal", [
        "filter deals",
        "move stages",
      ]),
      page(
        ...
        "Accounts",
        "private",
        "Manage companies, contacts, and ownership.",
        "account",
        ["create account", "assign owner"],
      ),
      page("/crm/leads", "Leads", "private", "Capture and qualify inbound leads.", "lead", [
        "create lead",
        "convert lead",
      ]),
      page(
        ...
        "Deal detail",
        "private",
        "Inspect deal activity and next steps.",
        "deal",
        ["edit deal", "log activity"],
      ),
    ],
    components: [
      component(
        ...
        "list",
        ["/crm"],
        ["group deals by stage", "support drag-style stage changes"],
      ),
      component(
        "AccountTable",
        "list",
        ["/crm/accounts"],
        ["sort accounts", "show owner and status"],
      ),
      component(
        "LeadCaptureForm",
        "form",
        ["/crm/leads"],
        ["validate lead source", "create qualified leads"],
      ),
      component(
        "ActivityTimeline",
        "detail",
        ["/crm/deals/:dealId"],
        ["show notes", "show stage changes"],
      ),
      component(
        "RevenueSummary",
        "chart",
        ["/crm"],
        ["summarize open value", "highlight stale deals"],
      ),
    ],
    entities: [
      entity(
        ...
        ["ownerId", "status"],
        ["account has many contacts", "account has many deals"],
      ),
      entity(
        "lead",
        [
        ...
        ["status", "score"],
        ["lead may convert into account and deal"],
      ),
      entity(
        "deal",
        [
    ...
    seeds: {
      account: [
        ...
        },
        {
          ...
          ownerId: "user_admin",
          status: "churn_risk",
          createdAt: "2025-11-19T16:42:00Z",
        },
        {
          id: "acc_005",
      ...
      lead: [
        {
          id: "lead_001",
          name: "Morgan Lee",
          email: "morgan.lee@northwind.example",
          source: "Inbound",
          score: 82,
          status: "qualified",
        },
        ...
        },
        {
          id: "lead_003",
          name: "Sasha Kim",
          email: "sasha.kim@summit.example",
          source: "Event",
          score: 71,
          status: "qualified",
        },
        {
          id: "lead_004",
          name: "Devon Rivers",
          email: "devon@cascadelogistics.example",
          source: "Outbound",
          score: 48,
          status: "new",
        },
        {
          id: "lead_005",
          name: "Priya Shah",
          email: "priya@acmerobotics.example",
          source: "Partner",
          score: 91,
          status: "converted",
        },
      ...
      deal: [
        ...
        },
        {
          id: "deal_004",
          accountId: "acc_004",
          title: "Cascade contract renewal",
          stage: "negotiation",
          value: 31000,
        ...
        },
        {
          id: "deal_005",
          accountId: "acc_006",
          title: "Summit advisory engagement",
          stage: "won",
          value: 56000,
  ...
  },
  {
    ...
    pages: [
      page(
        ...
        "Booking home",
        "public",
        "Introduce services and route visitors to booking.",
        undefined,
        ["start booking"],
      ),
      page(
        ...
        "Book appointment",
        "public",
        "Collect customer details and reserve a slot.",
        "appointment",
        ["select service", "select slot", "confirm"],
      ),
      page(
        "/appointments",
        "Appointments",
      ...
      page(
        ...
        "Appointment detail",
        "private",
        "Review customer, service, and notes.",
        "appointment",
        ["edit appointment", "add note"],
      ),
      page(
        "/settings/services",
        "Services",
        "admin",
        "Maintain services, providers, and availability.",
        "service",
        ["create service", "edit availability"],
      ),
    ],
    components: [
      component(
        ...
        "form",
        ["/book"],
        ["show active services", "store selected service"],
      ),
      component(
        "SlotPicker",
        "form",
        ["/book"],
        ["show available slots", "prevent double booking"],
      ),
      component(
        "AppointmentCalendar",
        "list",
        ["/appointments"],
        ["group appointments by day", "show status"],
      ),
      component(
        "ProviderRoster",
        "list",
        ["/settings/services"],
        ["manage provider availability", "show assigned services"],
      ),
      component(
        "ConfirmationPanel",
        "detail",
        ["/book", "/appointments/:appointmentId"],
        ["summarize booking", "show confirmation status"],
      ),
    ],
    entities: [
      entity(
      ...
      entity(
        ...
        ["startsAt", "providerId", "status"],
        ["appointment belongs to service", "appointment belongs to provider"],
      ),
    ],
    seeds: {
      service: [
      ...
      provider: [
        {
          id: "pro_001",
          name: "Jamie Rivera",
          email: "jamie.rivera@booking.example",
        ...
        },
        {
          id: "pro_002",
          name: "Sam Chen",
          email: "sam.chen@booking.example",
        ...
        },
        {
          id: "pro_003",
          name: "Avery Johnson",
          email: "avery.johnson@booking.example",
        ...
        },
        {
          id: "pro_004",
          name: "Reese Okonkwo",
          email: "reese.okonkwo@booking.example",
      ...
      appointment: [
        {
          ...
          customerEmail: "taylor.quinn@northwind.example",
          startsAt: "2026-05-19T15:00:00Z",
          status: "confirmed",
        },
        {
          id: "apt_002",
          ...
          customerEmail: "hannah.brooks@helix.example",
          startsAt: "2026-05-20T17:30:00Z",
          status: "pending",
        },
        {
          id: "apt_003",
          ...
          customerEmail: "liam.carter@summit.example",
        ...
        },
        {
          ...
          customerEmail: "nina.alvarez@cascade.example",
        ...
        },
        {
          ...
          customerEmail: "owen.park@acmerobotics.example",
  ...
  },
  {
    ...
    pages: [
      ...
      page(
        ...
        "Dashboard",
        "private",
        "Scan KPIs, trends, and operational status.",
        "metricSnapshot",
        ["filter metrics", "inspect trends"],
      ),
      page(
        "/reports",
        "Reports",
        "private",
        "Create and share saved operating reports.",
        "report",
        ["create report", "export report"],
      ),
      page("/alerts", "Alerts", "private", "Triage threshold breaches and incidents.", "alert", [
        "acknowledge alert",
        "resolve alert",
      ]),
      page(
        ...
        "Dashboard settings",
        "admin",
        "Configure metrics, thresholds, and access.",
        undefined,
        ["edit thresholds"],
      ),
    ],
    components: [
      component(
        ...
        "chart",
        ["/dashboard"],
        ["show current values", "compare against targets"],
      ),
      component(
        "TrendChart",
        "chart",
        ["/dashboard", "/reports"],
        ["plot metric history", "highlight anomalies"],
      ),
      component(
        "AlertTable",
        "list",
        ["/alerts"],
        ["sort alerts by severity", "acknowledge alerts"],
      ),
      component(
        "ReportBuilder",
        "form",
        ["/reports"],
        ["choose metrics", "save report definitions"],
      ),
      component(
        "DashboardFilters",
        "navigation",
        ["/dashboard"],
        ["filter by team", "filter by date range"],
      ),
    ],
    entities: [
      entity(
        ...
        ["metric snapshots power reports and alerts"],
      ),
      entity(
        "alert",
        [
      ...
      alert: [
        {
          ...
          severity: "warning",
          status: "open",
          message: "SLA risk index above target for 3 consecutive days.",
        ...
        },
        {
          ...
          severity: "critical",
          status: "acknowledged",
          message: "API p95 latency exceeded 300ms during peak window.",
          createdAt: "2026-05-14T19:42:00Z",
        },
        {
          id: "alrt_003",
          metricKey: "mrr",
          severity: "info",
          status: "open",
          message: "MRR pacing 8% below quarterly plan.",
        ...
        },
        {
          ...
          severity: "info",
          status: "resolved",
          message: "Brief uptime regression cleared after deploy rollback.",
          createdAt: "2026-05-12T22:11:00Z",
        },
      ],
      report: [
        {
          ...
          description: "Core operating metrics shared with leadership every Monday.",
          metricKeys: "activation_rate,sla_risk,support_csat",
          ownerId: "user_admin",
        ...
        },
        {
          ...
          description: "Support CSAT and SLA performance for the customer success team.",
          metricKeys: "support_csat,sla_risk",
          ownerId: "user_admin",
          updatedAt: "2026-05-10T16:30:00Z",
        },
        {
          id: "rep_003",
          name: "Revenue pacing snapshot",
          description: "MRR trajectory against quarterly plan.",
          metricKeys: "mrr",
          ownerId: "user_admin",
        ...
        },
        {
          ...
          description: "Uptime and latency posture for the platform team.",
          metricKeys: "uptime_pct,p95_latency_ms",
          ownerId: "user_admin",
  ...
  },
  {
    ...
    pages: [
      ...
      page("/tasks", "Tasks", "private", "Search, filter, and update work items.", "task", [
        "create task",
        "bulk update",
      ]),
      page("/boards/:boardId", "Board", "private", "Move tasks through status columns.", "task", [
        "move status",
        "assign owner",
      ]),
      page("/projects", "Projects", "private", "Manage project scope and progress.", "project", [
        "create project",
        "archive project",
      ]),
      page(
        ...
        "Task detail",
        "private",
        "Review comments, metadata, and history.",
        "task",
    ...
    components: [
      ...
      component(
        ...
        "list",
        ["/boards/:boardId"],
        ["group tasks by status", "move tasks"],
      ),
      component(
        "TaskEditor",
        "form",
        ["/tasks", "/tasks/:taskId"],
        ["validate required fields", "save task updates"],
      ),
      component(
        "ProjectProgress",
        "chart",
        ["/projects"],
        ["show completion count", "highlight blocked work"],
      ),
    ...
    seeds: {
      project: [
        ...
        {
          id: "prj_004",
          name: "Platform reliability hardening",
          status: "active",
          ownerId: "user_platform",
      ...
      task: [
        {
          id: "tsk_001",
          projectId: "prj_001",
          title: "Lock launch scope with marketing",
          description:
            "Confirm the feature list, messaging, and rollout date with the marketing leads.",
          status: "doing",
          priority: "high",
        ...
        },
        {
          ...
          description: "Write the welcome sequence and review with lifecycle.",
          status: "todo",
          priority: "medium",
          assigneeId: "user_pm",
        },
        {
          id: "tsk_003",
          projectId: "prj_002",
          title: "Audit accessibility on the new flows",
          description: "Run axe and keyboard checks on the redesigned screens.",
          status: "doing",
          priority: "high",
        ...
        },
        {
          id: "tsk_004",
          projectId: "prj_002",
          title: "Wire up offline sync",
          description: "Resolve queued mutations when the device comes back online.",
          status: "blocked",
          priority: "high",
          assigneeId: "user_mobile",
        },
        {
          id: "tsk_005",
          projectId: "prj_004",
          title: "Migrate metrics to Prometheus",
          description: "Move the legacy StatsD pipeline to Prometheus with backfilled history.",
          status: "todo",
          priority: "medium",
          assigneeId: "user_platform",
        },
        {
          id: "tsk_006",
          projectId: "prj_004",
          title: "Document incident runbooks",
          description: "Refresh on-call runbooks for the top five paging alerts.",
          status: "done",
          priority: "low",
          assigneeId: "user_platform",
        },
      ...
      comment: [
        {
          ...
          taskId: "tsk_001",
          authorId: "user_admin",
          body: "Scope locked at three core features; marketing is drafting the press hits.",
          createdAt: "2026-04-22T14:00:00Z",
        },
        {
          id: "cmt_002",
          taskId: "tsk_003",
          authorId: "user_design",
          body: "Found two focus-trap regressions on the modal stack; opening sub-tasks.",
        ...
        },
        {
          ...
          body: "Blocked on the conflict-resolution spec landing this week.",
          createdAt: "2026-05-11T10:45:00Z",
        },
        {
          id: "cmt_004",
          taskId: "tsk_006",
          authorId: "user_platform",
          body: "Runbooks merged; archived the obsolete pager wiki.",
          createdAt: "2026-05-14T18:05:00Z",
        },
      ],
    },
    acceptanceChecks: [
  ...
  },
  {
    ...
    pages: [
      page(
        ...
        "Portal welcome",
        "public",
        "Describe portal value and direct customers to sign in.",
        undefined,
        ["sign in"],
      ),
      page(
        ...
        "Portal home",
        "private",
        "Show customer account status, requests, and documents.",
        "customer",
        ["review summary"],
      ),
      page(
        ...
        "request",
        ["create request", "comment on request"],
      ),
      page(
        "/portal/documents",
        "Documents",
        "private",
        "Browse shared files and invoices.",
        "document",
        ["download document"],
      ),
      page(
        ...
        "Customer admin",
        "admin",
        "Manage customers and portal access.",
        "customer",
        ["invite customer", "disable access"],
      ),
    ],
    components: [
      component(
        "PortalShell",
        "layout",
        ["/portal", "/portal/requests", "/portal/documents"],
        ["render customer navigation", "show account context"],
      ),
      component(
        "RequestForm",
        "form",
        ["/portal/requests"],
        ["validate request category", "create service request"],
      ),
      component(
        "RequestList",
        "list",
        ["/portal", "/portal/requests"],
        ["show request status", "filter open requests"],
      ),
      component(
        "DocumentVault",
        "list",
        ["/portal/documents"],
        ["list shared documents", "separate invoices"],
      ),
      component(
        "AdminCustomerTable",
        "list",
        ["/admin/customers"],
        ["manage customer access", "show account status"],
      ),
    ],
    entities: [
      entity(
        ...
        ["status", "primaryEmail"],
        ["customer has many requests", "customer has many documents"],
      ),
      entity(
        "request",
        [
      ...
      customer: [
        {
          id: "cus_001",
          name: "Acme Robotics",
          primaryEmail: "ops@acmerobotics.example",
          status: "active",
        ...
        },
        {
          id: "cus_002",
          name: "Bluebird Health",
          primaryEmail: "portal@bluebirdhealth.example",
          status: "active",
        ...
        },
        {
          id: "cus_003",
          name: "Cascade Logistics",
          primaryEmail: "billing@cascadelogistics.example",
          status: "invited",
        ...
        },
        {
          id: "cus_004",
          name: "Summit Financial Group",
          primaryEmail: "ap@summit-fg.example",
          status: "active",
          createdAt: "2026-01-30T14:42:00Z",
        },
        {
          id: "cus_005",
          name: "Helix Biosciences",
          primaryEmail: "accounts@helixbio.example",
          status: "disabled",
      ...
      request: [
        {
          ...
          customerId: "cus_001",
          category: "Billing",
          subject: "Update billing contact and PO number",
          status: "open",
        ...
        },
        {
          ...
          subject: "SSO redirect loop after IdP rotation",
          status: "waiting",
        ...
        },
        {
          ...
          subject: "Export quarterly summary as PDF",
          status: "open",
        ...
        },
        {
          ...
          subject: "Add three seats for the integrations team",
          status: "resolved",
        ...
        },
        {
          ...
          customerId: "cus_003",
          category: "Onboarding",
          subject: "Schedule kickoff and grant portal access",
          status: "open",
      ...
      document: [
        {
          id: "doc_001",
          customerId: "cus_001",
          title: "April 2026 invoice",
          kind: "invoice",
          url: "/files/acme-april-2026-invoice.pdf",
        ...
        },
        {
          ...
          kind: "contract",
          url: "/files/bluebird-msa-2026.pdf",
          visibleToCustomer: true,
        },
        {
          id: "doc_003",
          customerId: "cus_004",
          title: "Q1 2026 usage report",
          kind: "file",
          url: "/files/summit-q1-2026-usage.pdf",
          visibleToCustomer: true,
        },
        {
          id: "doc_004",
          ...
          kind: "invoice",
          url: "/files/acme-march-2026-invoice.pdf",
          visibleToCustomer: true,
        },
        {
          id: "doc_005",
          ...
          kind: "file",
          url: "/files/cascade-onboarding-playbook.pdf",
...
export const PHASE_71_INTEGRATIONS: Phase71IntegrationDefinition[] = [
  {
    ...
    setupGuidance: [
      "Set OPENAI_API_KEY or connect the OpenAI provider before enabling live model calls.",
    ],
  },
  {
    id: "anthropic",
    ...
    setupGuidance: [
      "Set ANTHROPIC_API_KEY or connect the Anthropic provider before enabling live model calls.",
    ],
  },
  {
    id: "ollama",
  ...
  },
  {
    ...
    setupGuidance: [
      "Set CUSTOM_API_BASE_URL plus CUSTOM_API_KEY, or the PACKETAGENT_CUSTOM_API_* equivalents, before live custom API calls.",
    ],
  },
  {
    id: "slack_webhook",
    ...
    setupGuidance: [
      "Set SLACK_WEBHOOK_URL for outbound Slack messages and WEBHOOK_SIGNING_SECRET for signed inbound events.",
    ],
  },
  {
    id: "email",
    ...
    setupGuidance: [
      "Configure RESEND_API_KEY, SENDGRID_API_KEY, POSTMARK_TOKEN, or SMTP_URL before sending live email.",
    ],
  },
  {
    id: "github",
    ...
    setupGuidance: [
      "Connect the GitHub connector or set GITHUB_TOKEN/GH_TOKEN before live repository actions.",
    ],
  },
  {
    id: "browser",
    ...
    setupGuidance: [
      "Enable browser-use or Playwright runtime settings before live browser extraction.",
    ],
  },
  {
    id: "stripe",
    ...
    setupGuidance: [
      "Set STRIPE_SECRET_KEY, STRIPE_WEBHOOK_SECRET, and any required STRIPE_PRICE_ID values before live payments.",
    ],
  },
  {
    id: "database",
